				...
				"import/no-restricted-paths": [
					"error",
					{
						"zones": [{
							...
							"from": "./assets/Script/platform",
							"target": "./assets/Script/core",
							"message": "Do not use platform directly! Please use dependency inversion instead."
						}, {
							"from": "./assets/Script/app",
							"target": "./assets/Script/core",
							"message": "Core -> App dependency are blocked!"
						}, {
							"from": "./assets/Script/app",
							"target": "./assets/Script/gameplay",
							"message": "Game -> App dependency are blocked!"
						}, {
							"from": "./assets/Script/app",
							"target": "./assets/Script/platform",
							"message": "Platform -> App dependency are blocked!"
						}, {
							"from": "./assets/Script/gameplay",
							"target": "./assets/Script/core",
							"message": "Core -> Game dependency are blocked!"
						}]
					}
				]
			}
